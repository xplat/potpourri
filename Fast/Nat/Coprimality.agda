...
module Fast.Nat.Coprimality where
...
gcd′ m n | Bézout.result zero dm dn b rewrite 0∣⇒≡0 dm | 0∣⇒≡0 dn
  = 0 , gcd-* 1 1 (1-coprimeTo 1)
gcd′ ._ ._ | Bézout.result (suc d) (divides q₁ refl) (divides q₂ refl) b
  = suc d , gcd-* q₁ q₂ (Bézout-coprime b)
